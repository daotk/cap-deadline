        		...
        		<tr style="height: 100%; width: 100%;">
					...
					<td style="background-color: #ffffff; width: 350px;height:100%;" valign="top">				
						...
						<!-- configuration pop-up -->  
					  	<div class="popup-box" id="popup-box-1"><div class="close"><img src="images/close2.png" style="border: 0; margin-right: 5px; margin-top: 5px;" /></div>
					  		<div class="top">
										...
										<a href="${pageContext.request.contextPath}/dsluutam?topic=${Questionmanagement.ID}&page=${curentOfPage}" style ="text-decoration: none;">
											<div class="list-question" id="div_${Questionmanagement.ID}">
												<div class="row1">	
													...
													<div class="list-date">
														<fmt:formatDate value="${Questionmanagement.anwserDate}"  pattern="dd/MM/yyyy HH:mm" />
													</div>
												</div>						
												<div class="row3">
